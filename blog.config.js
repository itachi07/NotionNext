...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hawk', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '懒人一枚🐟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hawkxu.com', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品经理, Hi，我是一个程序员,Hi，我是一个懒人,欢迎来到我的博客🎉',
